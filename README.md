...
Dataset Description Structure of the Dataset Number of records: 100000 Number of columns: 9
...
A logistic regression model was chosen for its simplicity and effectiveness in binary classification problems. Parameters such as max_iter=1000 were set to ensure convergence.

Model Training and Evaluation
• Split the dataset into training and testing subsets. • Trained the logistic regression on training data. • Evaluated model performance using accuracy, confusion matrix, precision, recall, and F1-score.
